...
export default function CreateNotice() {
  ...
  const handleSubmit = async (isDraft: boolean) => {
    ...
    const notice = {
      ...
      commentEnabled,
      comments: [],
      publishedAt: isDraft ? null : useScheduled ? null : now,
    ...
    addNotice(notice, finalSendEmail, finalSendSms)

    if (priority === 'urgent' && (finalSendEmail || finalSendSms) && finalStatus === 'published') {
