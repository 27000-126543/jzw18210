...
export default function EditNotice() {
  ...
  const handleSave = (isDraft: boolean) => {
    ...
    const updates = {
      ...
      commentEnabled,
      publishedAt: isDraft ? null : scheduledEnabled ? notice.publishedAt : now,
